		...
		<section class="panel logo" scroll-panel="1">
			<div class="inner">
				...
				<div class="welcome" id="welcome">
					Bienvenidos a "Route to Praia de Xai-Xai". Gracias por participar y así poder ayudar a la funcación KHANIMAMBO y todo los chicos a los que llegan.
				</div>
				...
				<h2><span id="">Game</span></h2>
					<div class="ratio-wrapper">
						<div class="ratio-wrapper-content">
							<a href="game.html" class="play">start<!-- <img class="play_button" src="game/sprites/shared/play_button.png"> --></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="middle">
					<form class="form-horizontal" id="formulario" method="POST" action="functions.php" onsubmit="return formSubmit();" >
						...
						<div class="col-xs-12 col-sm-7">
							<h2><span id="">Dejanos tu mensaje</span></h2>
