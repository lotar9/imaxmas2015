...
function changeSocialLinks(newtext) {
	...
	$('.facebook-intent').attr('href','https://www.facebook.com/dialog/feed?app_id=&display=popup&caption='+newtext+'&link=http://www.imaweb.net/xmas2015').attr('target','_blank');
}
